...
predictions <- predict(ctree_model, newdata = full_dataset_processed)
...
levels_set <- union(levels(full_dataset$bad), unique(full_dataset$predictions))
full_dataset$predictions <- factor(full_dataset$predictions, levels = levels_set)
full_dataset$bad <- factor(full_dataset$bad, levels = levels_set)
